...
int main(int argc, char *argv[]) {
	...
	double dinero;
	int b_100, b_50, b_20, b_10, b_5, b_2, m_100, m_50, m_25, m_10, m_5, m_1, dinero_entero;
	
	cin >> dinero;
	
	dinero_entero = dinero;
	dinero -= (dinero - dinero_entero) * 100;
	...
	m_2 = (dinero - m_100 * 100 - m_50 * 50 - m_25 * 25 - m_10 * 10 - m_5 * 5) % 2;
